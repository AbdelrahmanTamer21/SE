...
function Home() {
  ...
  return (
    <div>
      <header className="hero bg-primary text-white text-center p-5" style={{ backgroundImage: `url(https://deijobs.in/blog/wp-content/uploads/2023/09/Mitigating-Unconscious-Bias.jpg)`, backgroundRepeat: "no-repeat", backgroundSize: "cover", color: "black !important" }}>
        <h1 style={{marginLeft: "8.5rem"}}>Welcome to Donation System </h1>
        <p style={{marginLeft: "8.5rem"}}>Connecting donors, volunteers, and organizations to make a difference.</p>
      </header>
