...
const MedicalDonations = donationData.filter(item => item.category === 'Medical Supplies');

function ViewListMedicalSupplies() {
...
export default ViewListMedicalSupplies;