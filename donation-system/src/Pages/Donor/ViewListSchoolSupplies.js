...
const ScoolSuppliesDonations = donationData.filter(item => item.category === 'School Supplies');

function ViewListSchoolSupplies() {
      ...
      <Row className='justify-content-center align-items-center'>
        <Col lg='9' className='my-5'>
          ...
          <Row xs={1} md={2} lg={3} className="g-4">
            {SchoolSuppliesDonations.map((post) => (
              <Col key={post.id}>
...
export default ViewListSchoolSupplies;